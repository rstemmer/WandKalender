...
class WKServerWebSocketProtocol(WebSocket, WKServerWebSocketInterface):
    """
    ...
    **It does not matter if this is a websocket client or not!**.
    ...
    def __init__(self):
        ...
        WKServerWebSocketInterface.__init__(self)
        logging.info("New protocolobject created for connection.")


class WKServerWebSocketServer(object):
    """
    ...
    """
    def __init__(self):
        self.factory    = WKServerWebSocketFactory()
        self.factory.protocol = WKServerWebSocketProtocol
